...
if (! function_exists('formFilamentContainer')) {
    ...
    /**
     * Column names for a relation manager. Unlike resources, a relation
     * manager's table() is an instance method, so the manager itself is the
     * HasTable container.
     *
     * @param  class-string  $managerClass
     * @return array<int, string>
     */
    function relationManagerColumnNames(string $managerClass): array
    {
    ...
    /**
     * Form field names for a relation manager (instance form()).
     *
     * @param  class-string  $managerClass
     * @return array<int, string>
     */
    function relationManagerFieldNames(string $managerClass): array
    {
        $manager = app($managerClass);
        ...
        $form = $manager->form($container::make($manager));
